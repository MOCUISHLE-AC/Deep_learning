...
def main():
    ...
    train_dataset = datasets.cifar.CIFAR100(root='./data/cifar100', train=True, transform=transform_train, download=True)
    test_dataset = datasets.cifar.CIFAR100(root='./data/cifar100', train=False, transform=transform_test, download=True)
